...
import { registerMentoringHandlers, initMentoringSocketListeners } from "./mentoring.socket.js";
...
export const initializeSocket = (httpServer) => {
    ...
    io.on("connection", async (socket) => {
        ...
        registerMentoringHandlers(io, socket);
    ...
    initMentoringSocketListeners(io);
