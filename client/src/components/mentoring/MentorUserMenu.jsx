  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        ...
        />
        <span className="material-symbols-outlined text-[#8b949e] group-hover:text-white transition-colors text-sm">
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute right-0 mt-3 w-56 bg-[#161b22] border border-[#30363d] rounded-xl shadow-2xl overflow-hidden z-[110] animate-in fade-in slide-in-from-top-2 duration-200">
          {/* User Info Header */}
          ...
          <div className="py-2">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-2 text-sm text-[#c9d1d9] hover:bg-[#30363d] hover:text-white transition-colors"
            >
          ...
          <div className="py-2 border-t border-[#30363d]">
            <button
