    ...
    <div className="w-full bg-[#0d1117] text-[#e6edf3] min-h-screen">
      ...
      <div className="relative flex min-h-[560px] flex-col items-center justify-center overflow-hidden px-4 py-20 md:px-10">
        ...
        <div className="relative z-10 flex flex-col gap-6 text-center max-w-4xl mx-auto mt-10">
          <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-[#161b22] border border-[#30363d] self-center mb-4 transition-transform hover:scale-105 cursor-default">
          ...
          <h2 className="text-[#8b949e] text-lg md:text-xl font-normal leading-relaxed max-w-2xl mx-auto mt-2">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mt-6">
            <button 
              className="px-8 py-3 rounded-lg bg-[#238636] text-white font-bold text-base hover:bg-[#2ea043] hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(46,160,67,0.4)] transition-all duration-200"
              onClick={() => handleGetStarted("student")}
            >
              I'm a Student
            </button>
            <button 
              className="px-8 py-3 rounded-lg bg-[#161b22] border border-[#30363d] text-[#c9d1d9] font-bold text-base hover:bg-[#21262d] hover:text-white hover:-translate-y-0.5 transition-all duration-200"
      ...
      <div className="flex flex-col gap-10 px-4 py-20 md:px-10 bg-[#0d1117] max-w-6xl mx-auto relative relative z-10 w-full">
        <SectionHeader
          title="How It Works"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mt-6">
          <div className="flex justify-center md:justify-end pr-0 md:pr-10 relative">
            ...
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-2xl bg-gradient-to-br from-[#238636] to-[rgba(35,134,54,0.1)] p-1 transform rotate-3 hover:rotate-6 transition-transform duration-500 shadow-2xl">
              <div className="w-full h-full rounded-xl bg-[#0d1117] border border-[#30363d] flex items-center justify-center p-8">
            ...
            {/* Glow behind */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-[#238636]/20 blur-3xl rounded-full -z-10" />
          </div>

          <div className="flex flex-col relative border-l-2 border-[#30363d] pl-6 md:pl-10 ml-4 md:ml-0">
            <StepItem
              number={1}
      ...
      {/* Features Section */}
      <div className="flex flex-col gap-10 px-4 py-20 md:px-10 bg-[#161b22] border-y border-[#30363d]">
      ...
      <div className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center gap-8 max-w-4xl mx-auto text-center border border-[#30363d] bg-[#161b22]/50 backdrop-blur-sm rounded-3xl p-10 md:p-16 shadow-2xl">
          <div className="flex flex-col gap-3">
            <h2 className="text-4xl md:text-5xl font-black text-[#c9d1d9] tracking-tight">
